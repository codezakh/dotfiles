# Configuratio file for ipython-kernel.
...
c.InteractiveShellApp.exec_files = [
        "/Users/zaidkhan/.ipython/profile_pretty/startup/custom_magics.py"
        ]
